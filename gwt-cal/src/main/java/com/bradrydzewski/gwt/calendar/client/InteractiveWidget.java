...
public abstract class InteractiveWidget extends Composite {
	...
	/**
	 * Used by focus widget to make sure a key stroke is only handled once by the
	 * calendar.
	 */
	...
	/**
	 * Processes mouse over events. Concrete interactive widgets should provide the
	 * component's specific logic.
	 * 
	 * @param element The HTML DOM element that originated the event
	...
	/**
	 * Processes mouse button pressing events. Concrete interactive widgets should
	 * provide the component's specific logic.
	 *
	 * @param element The HTML DOM element that originated the event
	 */
	...
	/**
	 * Processes {@link com.google.gwt.event.dom.client.KeyCodes.KEY_DELETE} and
	 * {@link com.google.gwt.event.dom.client.KeyCodes.KEY_BACKSPACE} keystrokes.
	 * Concrete interactive widgets should provide the component's specific logic.
	 */
	public abstract void onDeleteKeyPressed();

	/**
	 * Processes {@link com.google.gwt.event.dom.client.KeyCodes.KEY_UP} keystrokes.
	 * Concrete interactive widgets should provide the component's specific logic.
	 */
	...
	public void onBrowserEvent(Event event) {
		...
		case Event.ONMOUSEDOWN: {
			if (DOM.eventGetCurrentTarget(event) == getElement()) {
				...
				// TODO: Should not cancel onMouseDown events in the event an appointment would
				// have a child widget with a scrollbar (if this would ever even happen).
